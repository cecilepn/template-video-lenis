...
export interface VideoBlockSliceDefaultPrimary {
  ...
  /**
   * Video Link Mobile field in *VideoBlock → Default → Primary*
   *
   * - **Field Type**: Embed
   * - **Placeholder**: *None*
   * - **API ID Path**: video_block.default.primary.video_link_mobile
   * - **Documentation**: https://prismic.io/docs/fields/embed
   */
  video_link_mobile: prismic.EmbedField;

  /**
   * Media Desktop field in *VideoBlock → Default → Primary*
   *
   * - **Field Type**: Link to Media
   * - **Placeholder**: *None*
   * - **API ID Path**: video_block.default.primary.media_desktop
   * - **Documentation**: https://prismic.io/docs/fields/link-to-media
   */
  media_desktop: prismic.LinkToMediaField<prismic.FieldState, never>;

  /**
   * Media Mobile field in *VideoBlock → Default → Primary*
   *
   * - **Field Type**: Link to Media
   * - **Placeholder**: *None*
   * - **API ID Path**: video_block.default.primary.media_mobile
   * - **Documentation**: https://prismic.io/docs/fields/link-to-media
   */
  media_mobile: prismic.LinkToMediaField<prismic.FieldState, never>;
}
